...
export default defineNuxtConfig({
    ...
    head: {
      meta: [
        ...
        { name: "viewport", content: "width=device-width, initial-scale=1" },
        {
          name: "description",
          content:
            "Fabian Daume is a versatile UI/UX developer who specializes in building accessible, exceptional digital experiences.",
        },
  ...
  modules: ["@nuxtjs/tailwindcss", "@pinia"],
  plugins: [
