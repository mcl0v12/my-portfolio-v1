...
<template>
    ...
    >
      ...
      >
        ...
        <g v-if="symbol === 'X'">
          ...
          <line x1="19.5" y1="4.5" x2="4.5" y2="19.5" stroke="currentColor" stroke-width="2" />
        </g>
  
        <!-- Minus-Zeichen -->
        <g v-if="symbol === '-'">
          <line x1="4.5" y1="12" x2="19.5" y2="12" stroke="currentColor" stroke-width="2" />
        </g>
  
        <!-- Plus-Zeichen -->
        <g v-if="symbol === '+'">
          <line x1="4.5" y1="12" x2="19.5" y2="12" stroke="currentColor" stroke-width="2" />
          <line x1="12" y1="4.5" x2="12" y2="19.5" stroke="currentColor" stroke-width="2" />
        </g>
      </svg>
    </button>
  </template>
  ...
  const scaleFactor = computed(() => Math.min(props.width / 30, props.height / 30));
