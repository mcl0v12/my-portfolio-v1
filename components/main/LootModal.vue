          ...
          <div class="element-wrap">
            ...
            <div class="relative" :style="contentDivStyle">
              <div class="content-wrap">
                <LootItems :chestId="chestId" :items="lootItems" />
              </div>
            </div>
          </div>
        </div>
...
import LootItems from "~/components/main/LootItems.vue";
import { useLootStore } from "~/store/loot.js";

const lootStore = useLootStore();

const lootItems = computed(() => {
  return lootStore.lootItems[props.chestId] || [];
});
...
const isVisible = computed(() => {
  return lootStore.openModals[props.chestId];
});
